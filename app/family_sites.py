...
OK_SERIES_IDS = frozenset({"okramen", "okonsen", "okcaddie", "jpfun"})
...
SITE_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "emoji": "🎉",
        "name": "JPFun",
        "desc_en": "Japan leisure map — ski, surf, dive & camp",
        "desc_ko": "일본 레저 맵 — 스키·서핑·다이빙·캠핑",
        "desc_ja": "日本レジャーマップ",
    },
    {
        "id": "jpcampus",
...
FOOTER_GROUPS: dict[str, list[str]] = {
    "okramen": ["okonsen", "okcaddie", "jpfun"],
    "okonsen": ["okramen", "okcaddie", "jpfun"],
    "okcaddie": ["okramen", "okonsen", "jpfun"],
    "jpfun": ["okramen", "okonsen", "okcaddie"],
    "jpcampus": ["krcampus"],
