...
export const REGIONS_BY_ACTIVITY = {
    ...
    surf: [
        ...
        { key: 'chubu', label: 'Chubu / Shizuoka', countId: 'count-region-chubu' },
        { key: 'tohoku', label: 'Tohoku', countId: 'count-region-tohoku' },
...
const REGION_RULES = [
    ...
    ['kanto', /Kanto|Tokyo|Kanagawa|Chiba|Ibaraki|Saitama|도쿄|가나가와|치바|이바라키|関東|東京|神奈川|千葉|茨城|Fujisawa|Oarai|Isumi|Chigasaki|Tsujido|Kujukuri|Hakone/i],
    ['chubu', /Chubu|Yamanashi|Shizuoka|중부|야마나시|시즈오카|中部|山梨|静岡|Motosu|Fujikawaguchiko|Oshima|Ito|Shimoda|Ohsezaki|Iso/i],
    ['kyushu', /Kyushu|Kagoshima|Miyazaki|Oita|Fukuoka|Nagasaki|Kumamoto|큐슈|가고시마|미야자키|九州|鹿児島|Yakushima|Amami/i],
    ['shikoku', /Shikoku|Kochi|Tokushima|Ehime|Kagawa|시코쿠|고치|도쿠시마|四国|高知|徳島|Irisaki/i],
    ['chugoku', /Chugoku|Onomichi|Imabari|Hiroshima|주고쿠|오노미치|이마바리|中国|尾道|今治/i],
